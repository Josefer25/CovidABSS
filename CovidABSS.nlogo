...
globals
  [ %infected            ;; what % of the population is infectious
    ...
    muertes_vacuna
    muertes_naturales              ;;
    remaining-weekly-vaccines ;;
    chance-reproduce     ;; the probability of a turtle generating an offspring each tick
    carrying-capacity    ;; the number of turtles that can be in the world at one time
    immunity-duration-after-virus ;;
    immunity-duration-after-vaccine ]  ;; how many weeks immunity lasts
...
to setup
  ...
  update-display
  set muertes_naturales 0 ;;
  set muertes_virus 0 ;;
  set muertes_vacuna 0 ;;
  reset-ticks
end
...
to become-immune-after-virus ;; turtle procedure
  set sick? false
  set sick-time 0
  set remaining-immunity immunity-duration-after-virus
end


to become-immune-after-vaccine ;; turtle procedure
  set sick? false
  set sick-time 0
  set remaining-immunity immunity-duration-after-vaccine
end
...
to setup-constants
  ...
  set carrying-capacity 10000
  set chance-reproduce 1
  set immunity-duration-after-virus 12
  set immunity-duration-after-vaccine 52
end
...
to go
  ask turtles [
    get-older
    move
    if not sick? and not immune? and remaining-weekly-vaccines > 0 [ vaccinate ]
...
to update-global-variables
  if count turtles > 0
    [ set %infected (count turtles with [ sick? ] / count turtles) * 100
      ...
      set remaining-weekly-vaccines weekly-vaccines-applied
    ]
end
...
to get-older ;; turtle procedure
  ...
  set age age + 1
  if age > lifespan [ die-and-count-naturales ]
...
to vaccinate ;;
  if random-float 100 < vaccines-death-rate [ die-and-count-vacuna ] ;;
  become-immune-after-vaccine ;;
  set remaining-weekly-vaccines (remaining-weekly-vaccines - 1) ;;
end
...
to recover-or-die ;; turtle procedure
  ...
  if sick-time > duration                        ;; If the turtle has survived past the virus' duration, then
    [ ifelse random-float 100 < chance-recover   ;; either recover or die
      [ become-immune-after-virus ]
      [ die-and-count-virus ]
    ]
end

to die-and-count-virus;;

  set muertes_virus muertes_virus + 1 ;;
  die ;;

end

to die-and-count-vacuna;;

  set muertes_vacuna muertes_vacuna + 1 ;;
  die ;;

end

to die-and-count-naturales;;

  set muertes_naturales muertes_naturales + 1 ;;
  die ;;
